...
description: >-
  ...
  before they merge" — or invokes /jig:jig. Also handles explicit migration of
...
argument-hint: "[migrate --host codex|claude] [--quick] [--edition <id>] [--select <classId,…>] [--no-ci] [--observe]"
