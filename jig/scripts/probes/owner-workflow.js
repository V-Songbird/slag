...
const { fixtureGitEnvironment, withFixtureGitEnvironment, withCodexRuntime } = require("./fixture-isolation.js");
...
function runOwnerWorkflow(options = {}) {
  ...
  const runtime = (tool, text) => {
    ...
    const result = spawnSync(process.execPath, [path.join(__dirname, "..", "..", "hooks", "runner.js"), "PreToolUse", "--runtime", "codex", "--diagnostic"], {
  ...
  try {
    withCodexRuntime(() => withFixtureGitEnvironment(gitEnvironment, () => {
