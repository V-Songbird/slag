...
// name or not at all.
const CHANGE_KINDS = ["write-side-file", "write-config", "include-line", "write-settings", "write-rule"];
const INSTALLABLE_KINDS = ["write-side-file", "write-config", "include-line", "write-settings", "write-rule"];
...
const AVAILABLE_NOW = "0.4.0-alpha";
