...
description: >-
  ...
  one difference is that the findings are written for Claude Haiku 4.5. Use when the
  user wants their instruction files audited for Haiku — e.g. "grade my rules for Haiku", "audit my CLAUDE.md for Haiku 4.5", "my subagents run on Haiku, check my rules" — or
  invokes /assay:haiku45 with any flags. Do NOT use for the AGENTS.md chain, which
