...
- **The same duty stated twice gets named once.** A rule copied from `CLAUDE.md` into a scoped rules file — or reworded and restated — is flagged with both locations and which copy looks worth keeping. Which one survives stays your call; the grade doesn't move either way.
